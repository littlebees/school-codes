...
class MinimalTopo( Topo ):
    ...
    def build( self ):
        ...
        h2 = self.addHost( 'h2' ,ip="10.0.0.10/24", defaultRoute = "via 10.0.0.1" )
        h3 = self.addHost( 'h3' ,ip="20.0.0.5/24", defaultRoute = "via 20.0.0.1" )
        h4 = self.addHost( 'h4' ,ip="30.0.0.5/24", defaultRoute = "via 30.0.0.1" )
