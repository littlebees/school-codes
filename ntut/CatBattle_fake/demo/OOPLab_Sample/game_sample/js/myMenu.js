var MyMenu = Framework.exClass(Framework.GameMainMenu , {
    ...
    loadingProgress: function(ctx, requestInfo) {
        ...
        ctx.fillStyle = 'white';
        ctx.fillText(Math.round(requestInfo.percent) + '%' , ctx.canvas.width / 2 , ctx.canvas.height / 2 + 190);
    },
	...
	load: function(){
        ...
        this.photo = new Framework.Sprite(define.imagePath + 'cover.jpg');
        ...
        this.rightArrow.scale = 0.2;
        this.rightArrow.position = {
            x: Framework.Game.getCanvasWidth() / 2 - 220,
            y: Framework.Game.getCanvasHeight() / 4 * 3
        };
    ...
    draw: function(parentCtx) { 
        ...
        parentCtx.font = "20px Georgia";
        parentCtx.fillStyle = "#000000";
        parentCtx.fillText("按任意鍵觀看遊戲說明", 420, 450);
    },
